                    ...
                    <div class="app-main" id="main">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- Services -->
                                ...
                                <div class="backfront">
                                    <form class="row g-3 text-center" method="POST" action="{{ route('admin.addnewmember') }}" >
                                        @csrf
                                        <div class="col-12">
                                            <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Title" name="title" required>
                                                ...
                                                @enderror
                                                <input type="text" class="form-control mt-3 @error('surname') is-invalid @enderror" placeholder="Surname" name="surname" required>
                                                @error('surname')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                            <input type="text" class="form-control mt-3 @error('first_name') is-invalid @enderror" placeholder="First name" name="first_name" required>
                                                @error('first_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                                <input type="text" class="form-control mt-3 @error('second_name') is-invalid @enderror" placeholder="Second name"  name="second_name" required>
                                                @error('second_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                            <input type="text" class="form-control mt-3 @error('phone_number') is-invalid @enderror" placeholder="Phone number" name="phone_number" required>
                                                @error('phone_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                                <input type="text" class="form-control mt-3 @error('whatsapp_number') is-invalid @enderror" placeholder="Whatsap number" name="whatsapp_number" required>
                                                @error('whatsapp_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                            <input type="email" class="form-control mt-3 @error('email') is-invalid @enderror" placeholder="Email" name="email" required>
                                                @error('email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                                <input type="text" class="form-control mt-3 @error('graduation_set_class') is-invalid @enderror" placeholder="Graduation set (class)"  name="graduation_set_class">
                                                @error('graduation_set_class')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                            <input type="text" class="form-control mt-3 @error('state_of_origin') is-invalid @enderror" placeholder="State of origin" name="state_of_origin" required>
                                                @error('state_of_origin')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                @enderror
                                                <input type="text" class="form-control mt-3 @error('occupation') is-invalid @enderror" placeholder="Occupation" name="occupation" required>
                                                @error('occupation')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-12 text-center">
                                            <button  id="add" class="btn-lg mt-3 border-0" style="width: 30%;" type="submit " >Add member</button>
                                        </div>
                                  </form>
                                </div>
                                <div class="col-lg-2"></div>
